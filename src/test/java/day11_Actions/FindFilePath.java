...
public class FindFilePath {
    ...
    public void test01(){
        ...
        String sonrakiPath="\\Desktop\\Sistem.txt"; // Başlangıç yolundan sonra dosyaya kadar olan yolu elimizle de yazıp bir String'e atayabiliriz
        ...
        Assert.assertTrue(Files.exists(Path.of(filePath))); // Dosyanın localde var olup olmadığını test ettik
        System.out.println(Files.exists(Path.of(filePath))); // Dosyanın var olup olmadığını test ederek sonucu görmek için sonucu boolean veri tipinde yazdırdık
    }
